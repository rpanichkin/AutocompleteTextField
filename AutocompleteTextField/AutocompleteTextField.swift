...
@IBDesignable class AutocompleteTextField: UITextField, UITextFieldDelegate {
    ...
    override func layoutSubviews() {
        label.frame = CGRect(x: padding, y: pixelCorrection,
                             width: bounds.size.width - padding * 2, height: bounds.size.height)
    ...
    override func textRect(forBounds bounds: CGRect) -> CGRect {
        return CGRect(x: bounds.origin.x + padding, y: bounds.origin.y,
                      width: bounds.size.width - (padding * 2), height: bounds.size.height)
    }
    ...
    private func setLabelContent(suggestion: String = "") {
        ...
        let attributedString = NSMutableAttributedString(
            string: suggestion,
            attributes: [.font: completionFont, .foregroundColor: completionColor]
        )
    ...
    private func suggestionToShow(searchTerm: String) -> String? {
        ...
        suggestion = nil
        let foundSuggestions = suggestions.flatMap { suggestion -> String? in
